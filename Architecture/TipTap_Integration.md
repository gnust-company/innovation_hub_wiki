...
### Markdown Rendering (AI Chat)
- FE dùng `react-markdown` + `remark-gfm` để render markdown từ AI responses.
- `@tailwindcss/typography` cung cấp prose styles cho markdown output.
- Dùng trong ChatBot component để hiển thị câu trả lời của Agent.
...
## Mối liên hệ
- [[Architecture/Database_Schema]] — Các cột JSONB.
- [[Architecture/Clean_Architecture]] — Storage pattern.
